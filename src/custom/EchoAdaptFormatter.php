...
class EchoAdaptFormatter
{
    /**
     * Format an array of result to provide to EchoAdapt a well formatted request body data
     *
     * @param array $data
     * @return string
     */
    ...
    /**
     * Format a $data to prepare it to send it to echo adapt, consisting in a json_encode
     *
     * @param $data
     * @return string
     */
